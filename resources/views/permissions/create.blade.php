...
@section('content')
    <div class="max-w-4xl mx-auto bg-white shadow rounded-lg p-4">
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold text-gray-800">Create Permissions</h2>
            <a
        ...
        <form action="" method="post">
            @csrf
            <div class="mb-5">
                <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">permission</label>
